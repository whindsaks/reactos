...
BrowseFolderCallback(HWND hwnd, UINT uMsg, LPARAM lParam, LPARAM lpData)
{
    switch (uMsg)
    {
        case BFFM_INITIALIZED:
            //Why does this not work? SHBrowseForFolderW broken?
            SendMessageW(hwnd, BFFM_SETEXPANDED, TRUE, lpData);
            SendMessageW(hwnd, BFFM_SETSELECTIONW, TRUE, lpData);
            //SendMessageW(hwnd, BFFM_SETEXPANDED, FALSE, (LPARAM)ILCreateFromPathW((WCHAR*)lpData));
            //SendMessageW(hwnd, BFFM_SETSELECTION, FALSE, (LPARAM)ILCreateFromPathW((WCHAR*)lpData));
            break;
