...
START_TEST(SHGetFileInfo)
{
    ...
    ok_int(SHGFI(L"", info, SHGFI_USEFILEATTRIBUTES | SHGFI_SYSICONINDEX) > 1, TRUE);
    ok_int(SHGFI(L"*", info, SHGFI_USEFILEATTRIBUTES | SHGFI_SYSICONINDEX) > 1, TRUE);
    ok_int(SHGFI(L"x", info, SHGFI_USEFILEATTRIBUTES | SHGFI_SYSICONINDEX) > 1, TRUE);
    ok_int(SHGFI(L"x:\\", info, SHGFI_USEFILEATTRIBUTES | SHGFI_SYSICONINDEX) > 1, TRUE);
}
