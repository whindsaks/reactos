...
static HRESULT SIC_FindOrAddIcon(F Func, CD CallerData, PCWSTR pszIcon, int iIcon, UINT GilOut)
{
    ...
    UINT HasIcon = 0;
    HICON hIcons[MAXSILCOUNT] = {}; // +1 for the odd case (we ask for two icons each time)
...
#if 0 // We handle SHIL_JUMBO correctly but it makes everything slower, disable for now.
